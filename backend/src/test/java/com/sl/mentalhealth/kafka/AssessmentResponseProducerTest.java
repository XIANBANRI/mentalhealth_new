...
class AssessmentResponseProducerTest {

  @Mock
  private KafkaTemplate<String, AssessmentResponseMessage> kafkaTemplate;

  @InjectMocks
  private AssessmentResponseProducer producer;
  ...
  void send_success() {
    ...
    verify(kafkaTemplate, times(1)).send(
        KafkaTopics.ASSESSMENT_RESPONSE,
        "req-001",
        message
    );
  }
